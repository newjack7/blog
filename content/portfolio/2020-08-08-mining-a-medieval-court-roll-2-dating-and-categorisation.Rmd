...
yearsCombined <- left_join(yearsCombined, lincsEvents)
...
fullDated <- full_join(lincsEvents, fullDates)
...
lincsEventsDated <- full_join(yearsDated, lincsEvents)
