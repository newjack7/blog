...
* A great deal of the Zotero functionality is available through [ZoteroBib](https://zbib.org/). This won’t preserve your references beyond your session although you can export via a [very nifty sharing system](https://zbib.org/faq#where-is-my-bibliography-stored). I imagine this is more useful for researchers working on one-off projects or undergraduates.
...
* You can simply drag and drop PDFs into Zotero and it will *usually* find the reference information. I advise against this though as it takes up some of your free Zotero cloud storage (300mb free. You can pay $20 a month for 2GB). I add via [another method](https://www.researchgate.net/publication/325828616_Tutorial_The_Best_Reference_Manager_Setup_Zotero_ZotFile_Cloud_Storage) and use a cloud based solution (Google Drive but other solutions would work as well) to store the PDFs.
